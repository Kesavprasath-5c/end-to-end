...
public class Rad_reportable {
	...
	public void reportable() throws Exception {
	   ...
	   driver.findElement(By.xpath("//label[contains(@class, 'mdc-text-field') and .//span[text()='Order Id']]//input[@class='mdc-text-field__input']")).sendKeys(caseid,Keys.ENTER);
	   ...
	   try {
 	   ...
 	   Thread.sleep(2000);
 	 //  driver.findElement(By.cssSelector(".Button-sc-9irl08-0.BlurCasesWarningModal__ConfirmButton-sc-1enev8t-2.bRxsDi.jHdpBg")).click();
